...
const ProgramComparisonTable = () => {
  ...
  const programsData = {
    ...
    "Cyprus Golden Visa": {
      ...
      "TIME TO PERMANENT RESIDENCY": "0",
      "TIME TO CITIZENSHIP": "7 years (or 3 if you know the language)",
    ...
    "Dominica CBI": {
      ...
      "TIME TO PERMANENT RESIDENCY": "0",
      "TIME TO CITIZENSHIP": "6-7 months",
      "PROCESSING PERIOD FROM SUBMISSION": "6-8 months",
      "MANDATORY VISIT TO THE COUNTRY": "No",
      "VISIT THE COUNTRY FOR BIOMETRICS": "No",
    ...
    "Portugal Golden Visa": {
      ...
      "Starting Cost for 1 person Before fees": "€280,000",
      "Cost for family of four": "€280,000",
      "Minimum holding period": "5 years",
      "Investment refundable": "Yes",
      ...
      "Corporate": "21%",
      "Capital Gains": "28%",
      "Special Tax Regime": "NHR available",
    ...
    "Portugal D7 Visa": {
      ...
      "Minimum Investment Required": "€760/month passive income",
      "Investment options": "Proof of passive income",
      "Starting Cost for 1 person Before fees": "€9,120/year",
      "Cost for family of four": "€15,000/year",
      "Minimum holding period": "N/A",
      "Investment refundable": "N/A",
    ...
    "Spain Citizenship by Descent": {
      ...
      "TIME TO PERMANENT RESIDENCY": "Immediate",
      "TIME TO CITIZENSHIP": "1-2 years",
      "PROCESSING PERIOD FROM SUBMISSION": "12-24 months",
      "MANDATORY VISIT TO THE COUNTRY": "Yes",
      "VISIT THE COUNTRY FOR BIOMETRICS": "Yes",
      "Number of visa-free countries accessible": "190",
      "Visa-free access to the Schengen area": "Yes",
      ...
      "Visa-free access to Russia": "No",
      "Visa-free access to China": "No",
      "Family Members who can be included in application": "Minor children",
      "Inclusion of new family members Possible": "Yes",
      "Transfer by inheritance": "Yes",
      "Right of residence, study and work in the country": "Yes",
      "Right to work": "Yes",
      "Recognition of second citizenship by the state": "Depends on origin country",
      "Program Benefits": "Full EU citizenship rights, no investment required, right to live and work anywhere in EU",
      "Top 10 Countries - Demand-side": "Argentina, Mexico, Cuba, Venezuela, Colombia, Philippines, Morocco, Equatorial Guinea, Peru, Dominican Republic",
      "Minimum Investment Required": "€0",
      "Investment options": "None - based on ancestry",
      "Starting Cost for 1 person Before fees": "€0",
      "Cost for family of four": "€0",
      "Minimum holding period": "N/A",
      "Investment refundable": "N/A",
      "Additional requirements": "Proof of Spanish ancestry, birth certificates",
      "Type of document": "Spanish Passport",
      "Document Validity period": "10 years",
      "Tax System": "Progressive",
      "Personal Tax": "Up to 47%",
      "Corporate": "25%",
      "Capital Gains": "19-26%",
      "Special Tax Regime": "Beckham Law available",
      "Details of Special Tax Regime": "Flat tax rate of 24% for qualifying expats",
      "Tax Treaty with the United States": "Yes",
      "Physical Residency Requirement": "No",
      "Additional Requirements": "Language and culture test required"
    }
  };
  ...
  const sections = [
    {
      ...
      indicators: [
        ...
        "MANDATORY VISIT TO THE COUNTRY",
